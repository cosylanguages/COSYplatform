...
## 👥 Group vs. 1-on-1 Class Guidelines

- **Group Lessons**:
  - Use `<cosy-group-instruction>` blocks for pair discussions and breakout rooms.
  - Rotate speaking turns so every student participates equally.
  - Utilize shared whiteboard tools for group brainstorming.
